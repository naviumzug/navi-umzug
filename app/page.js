...
function Header() {
  return <header className="header">
    <a href="#start" className="brand"><Image src="/images/logo.png" alt="Navi Umzug Logo" width={300} height={90} priority /></a>
    <nav>
      <a href="#leistungen">Leistungen</a><a href="#ueber-uns">Über uns</a><a href="#ablauf">Ablauf</a><a href="#kontakt">Kontakt</a>
    </nav>
...
export default function Home() {
  return <main>
    ...
    <section id="start" className="hero">
      <Image src="/images/team-fuhrpark.jpeg" alt="Navi Umzug Team mit Transportern" fill priority className="heroImg" />
      <div className="overlay" />
      <div className="heroContent">
        <p className="eyebrow">Hamburg & Umgebung · 24 Stunden erreichbar</p>
        <h1>Umzug & Entrümpelung<br/><span>zuverlässig aus einer Hand.</span></h1>
        <p>Umzüge, Entrümpelungen, Haushaltsauflösungen, Möbelmontage und Transporte – transparent, sorgfältig und stressfrei.</p>
        <div className="actions"><a className="btn" href="#kontakt">Kostenloses Angebot</a><a className="btn ghost" href={`https://wa.me/${whatsapp}`} target="_blank">WhatsApp schreiben</a></div>
        <div className="trust"><span>✓ Kostenlose Besichtigung</span><span>✓ Faire Angebote</span><span>✓ Kurzfristige Termine</span></div>
      </div>
    </section>
    ...
    <section className="map"><iframe title="Standort Navi Umzug" loading="lazy" src="https://www.google.com/maps?q=Karl-R%C3%BCther-Stieg+7,+21035+Hamburg&output=embed" /></section>
